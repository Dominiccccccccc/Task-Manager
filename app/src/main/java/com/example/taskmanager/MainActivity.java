...
public class MainActivity extends AppCompatActivity {
    ...
    TextView taskCompletedCountTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView check_weather_cardView = findViewById(R.id.check_weather_card);
        ...
        check_weather_cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, WeatherTask.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.create:
                        ...
                        break;
                    case R.id.history:
                        intent = new Intent(MainActivity.this, Task_History.class);
                        startActivity(intent);
                        break;
                    case R.id.pomodoro:
                        ...
                        break;
                    case R.id.weather:
                        intent = new Intent(MainActivity.this, WeatherTask.class);
                        startActivity(intent);
                        break;
    ...
    protected void onResume() {
        super.onResume();
        updateTaskList();
        int completedTaskCount = databaseHelper.getCompletedTaskCount();
        taskCompletedCountTextView = findViewById(R.id.task_completed_count);
        taskCompletedCountTextView.setText(String.valueOf(completedTaskCount));
    }
    ...
    public void updateTaskList() {
        ...
        if (taskNames.isEmpty()) {
            ...
            for (String taskName : taskNames) {
                ...
                String formattedDueDate = "Due Date: " + dueDate;
                ...
                taskCard.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        String selectedTaskName = (String) v.getTag();
